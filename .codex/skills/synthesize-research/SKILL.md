...
description: >
  ...
  insights, themes, opportunity areas, and recommendations. Primary input is
  user-pasted text or uploaded files. Invoke as $synthesize-research.
---
...
- **Pasted text**: Interview notes, transcripts, survey responses, feedback — paste directly into the conversation
- **Uploaded files**: Research documents, spreadsheets, recordings summaries

**With a connected knowledge base** (Notion/Confluence): Search for research documents, interview notes, and survey results.

**With a connected user feedback tool** (Intercom/Productboard/Canny): Pull recent support tickets, feature requests, and bug reports.
...
Apply thematic analysis — see the **user-research-knowledge** skill for detailed methodology including affinity mapping and triangulation techniques.
...
Order findings by priority (frequency × impact).
