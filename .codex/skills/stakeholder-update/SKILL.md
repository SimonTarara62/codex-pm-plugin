...
description: >
  ...
  Supports weekly, monthly, launch, and ad-hoc updates for executives,
  engineering, cross-functional partners, customers, and boards.
  Invoke as $stakeholder-update.
---
...
**With a connected project tracker** (Linear/Asana/Jira): Pull status of roadmap items and milestones. Identify completed items since last update. Surface items that are at risk or blocked.

**With a connected chat app** (Slack/Teams): Search for relevant team discussions and decisions. Find blockers or issues raised in channels. Identify key decisions made asynchronously.

**With a connected meeting transcription tool** (Fireflies/Gong/Otter): Pull recent meeting notes and discussion summaries. Find decisions and action items from relevant meetings.
...
Structure the update for the target audience. See the **stakeholder-comms-knowledge** skill for detailed templates, G/Y/R status definitions, and the ROAM risk communication framework. Use `templates/weekly-stakeholder-update.md` as a starting point for executive updates.

**For executives**: TL;DR, status color (🟢/🟡/🔴), key progress tied to goals, decisions made, risks with mitigation, specific asks, and next milestones. Keep it under 300 words.
...
**For boards**: Metrics-driven summary, strategic context, top 1-3 risks, and what you need from them. Very concise.
...
- **With a connected chat app**: Offer to draft the message formatted for posting
