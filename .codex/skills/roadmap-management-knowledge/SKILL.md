---
name: roadmap-management-knowledge
description: >
  Roadmap planning, prioritization frameworks (RICE, ICE, MoSCoW), Now/Next/Later,
  OKR alignment, dependency mapping, capacity planning. Auto-activates when creating
  a roadmap, reprioritizing features, mapping dependencies, choosing roadmap formats,
  or presenting roadmap tradeoffs to stakeholders.
---

# Roadmap Management Knowledge
...
### RICE Score
Score each initiative on four dimensions, then calculate RICE = (Reach × Impact × Confidence) / Effort
