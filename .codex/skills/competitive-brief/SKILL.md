...
description: >
  ...
  Uses web search as primary research source. Outputs competitor overview, feature
  comparison, positioning analysis, SWOT, and strategic implications.
  Invoke as $competitive-brief.
---
...
**Web search** (primary source): Use web search to research:
- Product pages and feature lists
- Pricing pages and packaging
- Recent product launches, blog posts, and changelogs (last 6-12 months)
- Press coverage and analyst reports
- Customer reviews and ratings (G2, Capterra, TrustRadius, App Store)
- Job postings (signal of strategic direction)
- Social media and community discussions

**With a connected knowledge base** (Notion/Confluence): Search for existing competitive analysis documents, win/loss reports, or sales battle cards.

**With a connected chat app** (Slack/Teams): Search for competitive mentions in sales or product channels. Find recent deal feedback involving competitors.

**Without connected tools**: Ask the user: "Do you have any existing competitive research, win/loss data, or customer feedback about competitors you can share?" Accept any format — this enriches the web research.
...
#### Feature Comparison
Compare capabilities across key areas relevant to the analysis. See the **competitive-analysis-knowledge** skill for rating frameworks and comparison matrix templates.

#### Positioning Analysis
Analyze how each competitor positions themselves — target customer, category claim, key differentiator, and value proposition. See the **competitive-analysis-knowledge** skill for positioning analysis frameworks.
...
- Offer to create a sales battle card using `templates/competitive-battlecard.md`
...
- Pricing is hard to compare fairly. Note caveats (different packaging, usage-based vs seat-based, enterprise custom pricing).
