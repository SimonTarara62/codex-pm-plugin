---
name: competitive-analysis-knowledge
description: >
  Competitive landscape mapping, feature comparison matrices, positioning analysis,
  win/loss methodology, market trend identification, strategic response frameworks.
  Auto-activates when researching a competitor, comparing product capabilities,
  assessing competitive positioning, or preparing competitive strategy.
---
...
- **Pricing structure**: Not always cheaper — sometimes different pricing model fits better
...
- **Conference themes**: What are industry events focusing on?
