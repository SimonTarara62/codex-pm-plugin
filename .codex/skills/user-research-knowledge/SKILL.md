...
description: >
  Qualitative and quantitative research synthesis, thematic analysis, affinity mapping,
  triangulation, persona development, opportunity sizing. Auto-activates when analyzing
  interview notes, survey responses, support tickets, or behavioral data to identify
  themes, build personas, or prioritize opportunities.
---
...
- **Distribution**: Look at the shape of responses, not just averages. A bimodal distribution tells a different story than a normal distribution.
...
3. **Create persona profiles**: For each behavioral cluster — name, key behaviors and goals, pain points and needs, context, representative quotes
