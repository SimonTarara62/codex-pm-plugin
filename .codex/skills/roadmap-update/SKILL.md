...
name: roadmap-update
description: >
  Update, create, or reprioritize a product roadmap. Supports adding items,
  changing statuses, reprioritizing, shifting timelines, and building from scratch.
  Invoke as $roadmap-update.
---
...
- Apply a prioritization framework if helpful — see the **roadmap-management-knowledge** skill for RICE, MoSCoW, ICE, and value-vs-effort frameworks
...
- Use the template at `templates/roadmap-now-next-later.md` for the Now/Next/Later format
...
- **With a connected project tracker**: Offer to describe what updates to make in the project tracker
