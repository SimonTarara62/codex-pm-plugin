...
description: >
  ...
  Primary input is user-provided data (table, CSV, or description). Outputs
  metric scorecard, trend analysis, bright spots, areas of concern, and
  recommended actions. Invoke as $metrics-review.
---
...
- The metrics and their values — paste a table, CSV, screenshot description, or just describe the numbers
- Comparison data (previous period, targets) — even rough estimates are helpful
