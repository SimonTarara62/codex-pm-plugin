---
name: stakeholder-comms-knowledge
description: >
  Stakeholder updates by audience (executives, engineering, cross-functional, customers),
  status reporting (Green/Yellow/Red), risk communication (ROAM), decision documentation
  (ADR/DACI), meeting facilitation. Auto-activates when writing status updates, stakeholder
  communications, risk reports, or facilitating team meetings.
---

# Stakeholder Communications Knowledge
...
**Tips**: Keep it to 15 minutes. Focus on blockers. Track and follow up on resolution. Cancel if there is nothing to sync on.
...
**Tips**: Come with a proposed priority order. Push back on overcommitment. Ensure every item has a clear owner and acceptance criteria.
...
**Tips**: Focus on systems and processes, not individuals. Limit to 1-3 action items. Follow up on previous retro action items.
...
**Tips**: Demo the real product whenever possible. Frame feedback collection: "What feedback do you have on X?" is better than "Any thoughts?" Capture feedback visibly and commit to addressing it (or explaining why not).
